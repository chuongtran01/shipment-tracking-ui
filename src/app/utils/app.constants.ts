export const constants = {
  ...
  home: {
    ...
    overview: {
      ...
      overview: "Overview",
      description: "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna At vero eos et accusam ea rebum."
    },
    benefits: [
      {
        id: 1,
